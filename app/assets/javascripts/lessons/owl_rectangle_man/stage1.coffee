initOwlRectangleManStage1Challenges = ->
  if (page = $('#owl_rectangle_man_stage1')).length > 0
    ...
    initOwlRectangleManStage1Challenge7(page)
    initOwlRectangleManStage1Challenge8(page)
...
initOwlRectangleManStage1Challenge7 = (page) ->
  ...
  challenge.find('.run').click ->
    canvas.selfAssess ->
      App.currentProgress.challengeComplete('owl_rectangle_man_stage1', 'challenge7')
...
initOwlRectangleManStage1Challenge8 = (page) ->
  ...
  challenge.find('.run').click ->
    canvas.selfAssess ->
      App.currentProgress.challengeComplete('owl_rectangle_man_stage1', 'challenge8')
