(function() {
  var initSaveChallenge1, initSaveChallenge2, initSaveChallenge3, initSaveChallenge4, initSaveChallenge5, initSaveChallenges;

  initSaveChallenges = function() {
    var page;
    if ((page = $('#save')).length > 0) {
      ...
      return initSaveChallenge5(page);
    }
  };

  initSaveChallenge1 = function(page) {
  ...
  initSaveChallenge2 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initSaveChallenge3 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initSaveChallenge4 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initSaveChallenge5 = function(page) {
    var canvas, challenge, editor, solution, testCode;
