(function() {
  var initForLoopsChallenge1, initForLoopsChallenge2, initForLoopsChallenge3, initForLoopsChallenge4, initForLoopsChallenge5, initForLoopsChallenge6, initForLoopsChallenges;

  initForLoopsChallenges = function() {
    var page;
    if ((page = $('#for_loops')).length > 0) {
      ...
      return initForLoopsChallenge6(page);
    }
  };

  initForLoopsChallenge1 = function(page) {
  ...
  initForLoopsChallenge2 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initForLoopsChallenge3 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initForLoopsChallenge4 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initForLoopsChallenge5 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initForLoopsChallenge6 = function(page) {
    var canvas, challenge, editor, solution, testCode;
