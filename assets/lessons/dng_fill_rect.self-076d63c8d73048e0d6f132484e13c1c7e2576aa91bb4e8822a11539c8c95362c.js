(function() {
  var initDngFillRectChallenge1, initDngFillRectChallenge2, initDngFillRectChallenge3, initDngFillRectChallenge4, initDngFillRectChallenge5, initDngFillRectChallenge6, initDngFillRectChallenges;
  ...
  initDngFillRectChallenges = function() {
    ...
    if ((page = $('#dng_fill_rect')).length > 0) {
      ...
      return initDngFillRectChallenge6(page);
    }
  };
  ...
  initDngFillRectChallenge4 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initDngFillRectChallenge5 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initDngFillRectChallenge6 = function(page) {
    var canvas, challenge, editor, solution, testCode;
