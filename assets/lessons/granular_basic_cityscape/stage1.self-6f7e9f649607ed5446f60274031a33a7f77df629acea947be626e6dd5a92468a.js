(function() {
  var challenge4Solution, challenge5Solution, challenge6Solution, initBasicCityscapeStage1Challenge1, initBasicCityscapeStage1Challenge2, initBasicCityscapeStage1Challenge3, initBasicCityscapeStage1Challenge4, initBasicCityscapeStage1Challenge5, initBasicCityscapeStage1Challenge6, initBasicCityscapeStage1Challenges;
  ...
  initBasicCityscapeStage1Challenges = function() {
    ...
    if ((page = $('#granular_basic_cityscape_stage1')).length > 0) {
      ...
      return initBasicCityscapeStage1Challenge6(page);
    }
  };
  ...
  challenge4Solution = function(canvas, context) {
  ...
  challenge5Solution = function(canvas, context) {
