(function() {
  ...
  initBasicCityscapeStage4Challenge1 = function(page) {
    ...
    return challenge.find('.run').click(function() {
      return canvas.selfAssess(function() {
        return App.currentProgress.challengeComplete('granular_basic_cityscape_stage4', 'challenge1');
      });
    });
  };
  ...
  initBasicCityscapeStage4Challenge2 = function(page) {
    ...
    return challenge.find('.run').click(function() {
      return canvas.selfAssess(function() {
        return App.currentProgress.challengeComplete('granular_basic_cityscape_stage4', 'challenge2');
      });
    });
  };
  ...
  initBasicCityscapeStage4Challenge3 = function(page) {
    ...
    return challenge.find('.run').click(function() {
      return canvas.selfAssess(function() {
        return App.currentProgress.challengeComplete('granular_basic_cityscape_stage4', 'challenge3');
      });
    });
  };
  ...
  initBasicCityscapeStage4Challenge4 = function(page) {
    ...
    return challenge.find('.run').click(function() {
      return canvas.selfAssess(function() {
        return App.currentProgress.challengeComplete('granular_basic_cityscape_stage4', 'challenge4');
      });
    });
  };
