(function() {
  var initTranslateChallenge1, initTranslateChallenge2, initTranslateChallenge3, initTranslateChallenge4, initTranslateChallenge5, initTranslateChallenge6, initTranslateChallenges;
  ...
  initTranslateChallenges = function() {
    ...
    if ((page = $('#translate')).length > 0) {
      ...
      return initTranslateChallenge6(page);
    }
  };
  ...
  initTranslateChallenge2 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initTranslateChallenge3 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initTranslateChallenge4 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initTranslateChallenge5 = function(page) {
    ...
    return challenge.find('.run').click(function() {
      return canvas.selfAssess(function() {
        return App.currentProgress.challengeComplete('translate', 'challenge5');
      });
    });
  };

  initTranslateChallenge6 = function(page) {
    var canvas, challenge, editor, solution, testCode;
