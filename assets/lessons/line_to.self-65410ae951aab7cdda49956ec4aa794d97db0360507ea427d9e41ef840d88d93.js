(function() {
  var initLineToChallenge1, initLineToChallenge2, initLineToChallenge3, initLineToChallenge4, initLineToChallenge5, initLineToChallenge6, initLineToChallenges;
  ...
  initLineToChallenges = function() {
    ...
    if ((page = $('#line_to')).length > 0) {
      ...
      return initLineToChallenge6(page);
    }
  };
  ...
  initLineToChallenge4 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initLineToChallenge5 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initLineToChallenge6 = function(page) {
    var canvas, challenge, editor, solution, testCode;
