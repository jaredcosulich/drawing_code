(function() {
  var initFlappySquareStage2Challenge1, initFlappySquareStage2Challenge2, initFlappySquareStage2Challenge3, initFlappySquareStage2Challenge4, initFlappySquareStage2Challenge5, initFlappySquareStage2Challenges;
  ...
  initFlappySquareStage2Challenges = function() {
    ...
    if ((page = $('#flappy_square_stage2')).length > 0) {
      ...
      return initFlappySquareStage2Challenge5(page);
    }
  };
  ...
  initFlappySquareStage2Challenge4 = function(page) {
    ...
    return challenge.find('.run').click(function() {
      return setTimeout((function() {
        return canvas.selfAssess(function() {
          return App.currentProgress.challengeComplete('flappy_square_stage2', 'challenge4');
        });
      }), 2000);
    });
  };
