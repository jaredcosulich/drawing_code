(function() {
  var initIfStatementsChallenge1, initIfStatementsChallenge2, initIfStatementsChallenge3, initIfStatementsChallenges;

  initIfStatementsChallenges = function() {
    var page;
    if ((page = $('#if_statements')).length > 0) {
      initIfStatementsChallenge1(page);
      initIfStatementsChallenge2(page);
      return initIfStatementsChallenge3(page);
    }
  };

  initIfStatementsChallenge1 = function(page) {
    ...
    return challenge.find('.run').click(function() {
      return testCode.test(function(success) {
        ...
        if (success) {
          ...
          App.currentProgress.challengeComplete('if_statements', 'challenge1');
        } else {
  ...
  initIfStatementsChallenge2 = function(page) {
    var canvas, challenge, editor, solution, testCode;
    ...
    return challenge.find('.run').click(function() {
      return testCode.test(function(success) {
        ...
        if (success) {
          ...
          App.currentProgress.challengeComplete('if_statements', 'challenge2');
        } else {
  ...
  initIfStatementsChallenge3 = function(page) {
    ...
    return challenge.find('.run').click(function() {
      return canvas.selfAssess(function() {
        return App.currentProgress.challengeComplete('if_statements', 'challenge3');
      });
    });
  };

  $(document).on('initialization:complete', initIfStatementsChallenges);
