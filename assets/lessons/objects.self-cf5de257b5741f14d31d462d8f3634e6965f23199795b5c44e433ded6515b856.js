(function() {
  var initObjectsChallenge1, initObjectsChallenge2, initObjectsChallenge3, initObjectsChallenges;

  initObjectsChallenges = function() {
    var page;
    if ((page = $('#objects')).length > 0) {
      initObjectsChallenge1(page);
      initObjectsChallenge2(page);
      return initObjectsChallenge3(page);
    }
  };

  initObjectsChallenge1 = function(page) {
  ...
  initObjectsChallenge2 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initObjectsChallenge3 = function(page) {
    ...
    return challenge.find('.run').click(function() {
      return canvas.selfAssess(function() {
        return App.currentProgress.challengeComplete('objects', 'challenge3');
      });
    });
  };
