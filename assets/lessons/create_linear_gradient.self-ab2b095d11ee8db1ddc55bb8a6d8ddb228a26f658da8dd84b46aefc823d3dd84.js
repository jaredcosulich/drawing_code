(function() {
  var initCreateLinearGradientChallenge1, initCreateLinearGradientChallenge2, initCreateLinearGradientChallenge3, initCreateLinearGradientChallenges;

  initCreateLinearGradientChallenges = function() {
    var page;
    if ((page = $('#create_linear_gradient')).length > 0) {
      initCreateLinearGradientChallenge1(page);
      initCreateLinearGradientChallenge2(page);
      return initCreateLinearGradientChallenge3(page);
    }
  };

  initCreateLinearGradientChallenge1 = function(page) {
    ...
    return challenge.find('.run').click(function() {
      return testCode.test(function(success) {
        ...
        if (success) {
          ...
          App.currentProgress.challengeComplete('create_linear_gradient', 'challenge1');
        } else {
  ...
  initCreateLinearGradientChallenge2 = function(page) {
    var canvas, challenge, editor, solution, testCode;
    ...
    return challenge.find('.run').click(function() {
      return testCode.test(function(success) {
        ...
        if (success) {
          ...
          App.currentProgress.challengeComplete('create_linear_gradient', 'challenge2');
        } else {
  ...
  initCreateLinearGradientChallenge3 = function(page) {
    ...
    return challenge.find('.run').click(function() {
      return canvas.selfAssess(function() {
        return App.currentProgress.challengeComplete('create_linear_gradient', 'challenge3');
      });
    });
  };

  $(document).on('initialization:complete', initCreateLinearGradientChallenges);
