(function() {
  var initDngBasicCityscapeStage2Challenge1, initDngBasicCityscapeStage2Challenge2, initDngBasicCityscapeStage2Challenge3, initDngBasicCityscapeStage2Challenges;

  initDngBasicCityscapeStage2Challenges = function() {
    var page;
    if ((page = $('#dng_basic_cityscape_stage2')).length > 0) {
      ...
      return initDngBasicCityscapeStage2Challenge3(page);
    }
  };

  initDngBasicCityscapeStage2Challenge1 = function(page) {
  ...
  initDngBasicCityscapeStage2Challenge2 = function(page) {
    var canvas, challenge, editor, points;
  ...
  initDngBasicCityscapeStage2Challenge3 = function(page) {
    var canvas, challenge, editor, points;
