(function() {
  var initArraysChallenge1, initArraysChallenge2, initArraysChallenge3, initArraysChallenges;

  initArraysChallenges = function() {
    var page;
    if ((page = $('#arrays')).length > 0) {
      initArraysChallenge1(page);
      initArraysChallenge2(page);
      return initArraysChallenge3(page);
    }
  };

  initArraysChallenge1 = function(page) {
    ...
    return challenge.find('.run').click(function() {
      return testCode.test(function(success) {
        ...
        if (success) {
          ...
          App.currentProgress.challengeComplete('arrays', 'challenge1');
        } else {
  ...
  initArraysChallenge2 = function(page) {
    var canvas, challenge, editor, solution, testCode;
    ...
    return challenge.find('.run').click(function() {
      return testCode.test(function(success) {
        ...
        if (success) {
          ...
          App.currentProgress.challengeComplete('arrays', 'challenge2');
        } else {
  ...
  initArraysChallenge3 = function(page) {
    ...
    return challenge.find('.run').click(function() {
      return canvas.selfAssess(function() {
        return App.currentProgress.challengeComplete('arrays', 'challenge3');
      });
    });
  };

  $(document).on('initialization:complete', initArraysChallenges);
