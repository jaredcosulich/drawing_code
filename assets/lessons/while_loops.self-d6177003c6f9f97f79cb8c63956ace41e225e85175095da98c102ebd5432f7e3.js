(function() {
  var initWhileLoopsChallenge1, initWhileLoopsChallenge2, initWhileLoopsChallenge3, initWhileLoopsChallenges;

  initWhileLoopsChallenges = function() {
    var page;
    if ((page = $('#while_loops')).length > 0) {
      initWhileLoopsChallenge1(page);
      initWhileLoopsChallenge2(page);
      return initWhileLoopsChallenge3(page);
    }
  };

  initWhileLoopsChallenge1 = function(page) {
  ...
  initWhileLoopsChallenge2 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initWhileLoopsChallenge3 = function(page) {
    ...
    return challenge.find('.run').click(function() {
      return canvas.selfAssess(function() {
        return App.currentProgress.challengeComplete('while_loops', 'challenge3');
      });
    });
  };
