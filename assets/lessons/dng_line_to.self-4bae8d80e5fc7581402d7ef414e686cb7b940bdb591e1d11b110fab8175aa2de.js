(function() {
  var initDngLineToChallenge1, initDngLineToChallenge2, initDngLineToChallenge3, initDngLineToChallenge4, initDngLineToChallenge5, initDngLineToChallenge6, initDngLineToChallenges;

  initDngLineToChallenges = function() {
    var page;
    if ((page = $('#dng_line_to')).length > 0) {
      ...
      return initDngLineToChallenge6(page);
    }
  };

  initDngLineToChallenge1 = function(page) {
  ...
  initDngLineToChallenge2 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initDngLineToChallenge3 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initDngLineToChallenge4 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initDngLineToChallenge5 = function(page) {
    var canvas, challenge, editor, solution, testCode;
  ...
  initDngLineToChallenge6 = function(page) {
    var canvas, challenge, editor, solution, testCode;
